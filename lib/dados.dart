...
class feriado{
  ...
  feriado(this.nome,this.descricao,this.pais,this.data,this.tipo,this.locais,
      this.estados);
...
//
  ...
  String getDatalocal(){
    return data['datahora']['dia']/data['datahora']['mes']/
        data['datahora']['ano'];
  }

  @override
  String toString() {
    String dataFeriado =data['datahora']['dia']/data['datahora']['mes']/
        data['datahora']['ano'];
    return "Feriado: $nome\n"
        "Descrção: $descricao\n"
        "Data: ${data['datahora']['dia']/data['datahora']['mes']/
        data['datahora']['ano']}\n"
        "";
  }
}
