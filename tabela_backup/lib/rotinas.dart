...
/*
Future<String> leTeste () async{
  var txt;
  // ignore: non_constant_identifier_names
  Future <DocumentSnapshot> Snaptexto =   FirebaseFirestore.instance.
  collection('colecao').doc('documento').get();

  txt = jsonDecode(Snaptexto.toString());
  meuTexto = txt;
  return meuTexto;
}*/
